...
def init_db():
	...
	print("DATABASE INITIALIZATION RAN")
...
def get_cursor():
	...
	try:
		...
		connection.commit()
		print("<CI2> CONNECTION TO DB SUCCESFULL!")
	except mysql.connector.Error as err:
		print("<CI2.2> No connection to db!")
...
try:
	...
	print("<CE1> Could not fetch api data from config file!")
	print("Ending code...")
	exit()
# 	logger.exception('')
# logger.info('DONE')
print("<CI1> Config read successfuly!")
...
if __name__ == "__main__":
	...
	logger.info("<CI2> Request url: " + str(nasa_api_url + "rest/v1/feed?start_date=" + request_date + "&end_date=" + request_date + "&api_key=" + nasa_api_key))
